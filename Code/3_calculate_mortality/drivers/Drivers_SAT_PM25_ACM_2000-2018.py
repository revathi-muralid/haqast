...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 19 19:02:11 2022
...
Dir = "/nas/longleaf/home/revathi/chaq/revathi/mortality_results/ACM/SAT/"

# Hold values from 2000 constant for drivers analysis

dat1990 = pd.read_csv(Dir+'CDC_SAT_grid_mort_results_2000.csv')
...
for Year in range(startyear,endyear):
    ...
    dat_old = pd.read_csv(Dir+'CDC_SAT_grid_mort_results_'+str(Year)+'.csv')
   ...
   # Make copy of dat
    ...
    outfname = '/nas/longleaf/home/revathi/chaq/revathi/mortality_results/ACM/SAT/Drivers/CDC_SAT_grid_mort_drivers_'+str(Year)+'.csv'
