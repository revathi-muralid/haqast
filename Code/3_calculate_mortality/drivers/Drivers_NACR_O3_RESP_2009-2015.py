...
# -*- coding: utf-8 -*-
"""
Created on Fri Jan 21 22:35:34 2022
...
Dir = "/nas/longleaf/home/revathi/chaq/revathi/mortality_results/RESP/NACR/"

# Hold values from 2000 constant for drivers analysis

dat1990 = pd.read_csv(Dir+'CDC_NACR_grid_mort_results_2009.csv')
...
for Year in range(startyear,endyear):
    ...
    dat_old = pd.read_csv(Dir+'CDC_NACR_grid_mort_results_'+str(Year)+'.csv')
   ...
   # Make copy of dat
    ...
    outfname = '/nas/longleaf/home/revathi/chaq/revathi/mortality_results/RESP/NACR/Drivers/CDC_NACR_grid_mort_drivers_'+str(Year)+'.csv'
