...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec  2 09:13:15 2021
...
Dir = "/nas/longleaf/home/revathi/chaq/revathi/FAQSD/pm25/regridded/"
...
for Year in range(startyear,endyear):
    ...
    Filename = Dir + "FAQSD_PM25_Regridded_to_CONUS_12km_"+str(Year)+".nc"
...
#        lon_flat = lon_flat.reshape(lon_flat.size,1)
   ...
   # Make copy of dat
    ...
    outfname = '/nas/longleaf/home/revathi/chaq/revathi/mortality_results/ACM/FAQSD/CDC_FAQSD_grid_mort_results_'+str(Year)+'.csv'
