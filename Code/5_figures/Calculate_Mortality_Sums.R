...
d2<-data%>%group_by(Year)%>%summarise_at(vars(deaths_age1,deaths_RRlow_age1,deaths_RRup_age1,
                                              deaths_age2,deaths_RRlow_age2,deaths_RRup_age2,
                                              deaths_age3,deaths_RRlow_age3,deaths_RRup_age3,
                                              deaths_age4,deaths_RRlow_age4,deaths_RRup_age4,
                                              deaths_age5,deaths_RRlow_age5,deaths_RRup_age5,
                                              deaths_age6,deaths_RRlow_age6,deaths_RRup_age6,
                                              deaths_age7,deaths_RRlow_age7,deaths_RRup_age7),sum,na.rm=T)
...
d4_1<-d3_1%>%adorn_totals("row")
d4_2<-d3_2%>%adorn_totals("row")
d4_3<-d3_3%>%adorn_totals("row")
