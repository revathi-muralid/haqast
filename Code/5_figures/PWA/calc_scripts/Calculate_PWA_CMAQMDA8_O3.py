...
for Year in range(startyear,endyear):
   ...
   # Make copy of dat
    ...
    for i in range(0, dat.shape[0]):
        ...
        pwa_O3.append((dat['O3'].loc[i]*dat['P_TOT'].loc[i])/pop_tot)
    
    dat['PWA_O3'] = pwa_O3
    
    out = dat[['Lon', 'Lat','O3', 'P_TOT', 'PWA_O3']]

    # Set output filename
  
    outfname = '/nas/longleaf/home/revathi/HAQAST/thesis/Code/5_figures/PWA/CMAQ_O3_PWA_'+str(Year)+'.csv'
